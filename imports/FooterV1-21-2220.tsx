import svgPaths from "./svg-1kjbkeocfr";
...
export default function FooterV() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-center px-[15px] py-[25px] relative size-full" data-name="Footer v1">
      <Frame1 />
    </div>
  );
}