import svgPaths from "./svg-x1p4h8gfnk";
...
export default function ListItemNewmobile() {
  return (
    <div className="bg-[#e9e9ef] content-stretch flex flex-col gap-[5px] items-start overflow-clip p-[5px] relative rounded-[20px] size-full" data-name="listItemNewmobile">
      <Frame105 />
      <Frame161 />
    </div>
  );
