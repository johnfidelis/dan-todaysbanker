...
export default function Frame284() {
  return (
    <div className="backdrop-blur-[2px] bg-white content-stretch flex flex-col gap-[20px] items-start p-[20px] relative rounded-[20px] size-full">
      <Frame154 />
    </div>
  );
}