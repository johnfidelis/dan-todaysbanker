import svgPaths from "./svg-2x4dedpunv";
    ...
    <div className="relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10px] items-center justify-center px-[11px] py-[5px] relative w-full">
          <div className="capitalize flex flex-col font-['Lato',sans-serif] font-extrabold justify-center leading-[0] not-italic relative shrink-0 text-[#fafcff] text-[16px] text-center whitespace-nowrap">
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-end relative shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-bold leading-[18px] overflow-hidden relative shrink-0 text-[#1e1e1e] text-[11px] text-ellipsis text-right tracking-[0.2px]">Crystal Palace</p>
      <Frame />
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[7px] relative shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#1a1919] text-[11px] text-center tracking-[0.2px] w-full whitespace-pre-wrap">13:00</p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-bold leading-[18px] overflow-hidden relative shrink-0 text-[#1e1e1e] text-[11px] text-ellipsis tracking-[0.2px]">Manchester United</p>
      <Frame1 />
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex h-full items-center justify-center px-[5.943px] relative rounded-[2.971px] shrink-0">
      <div className="flex flex-col font-['Space_Grotesk',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#5a5a5a] text-[8.32px] text-center tracking-[0.0166px] uppercase whitespace-nowrap">
...
function Frame6() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="capitalize flex flex-col font-['Space_Grotesk',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#767676] text-[8.914px] text-center whitespace-nowrap">
...
function Frame23() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4.16px] py-[3.301px] relative rounded-[2.971px] shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-medium leading-[10.697px] relative shrink-0 text-[#1e1e1e] text-[8.32px] text-center tracking-[0.1189px]">2.04</p>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4.16px] py-[3.301px] relative rounded-[2.971px] shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-medium leading-[10.697px] relative shrink-0 text-[#1e1e1e] text-[8.32px] text-center tracking-[0.1189px]">3.14</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4.16px] py-[3.301px] relative rounded-[2.971px] shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-medium leading-[10.697px] relative shrink-0 text-[#1e1e1e] text-[8.32px] text-center tracking-[0.1189px]">2.00</p>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="content-stretch flex h-full items-center justify-center px-[5.943px] relative rounded-[2.971px] shrink-0">
      <div className="flex flex-col font-['Space_Grotesk',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#e9e9ef] text-[8.32px] text-center tracking-[0.0166px] uppercase whitespace-nowrap">
...
function Frame26() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4.16px] py-[3.301px] relative rounded-[2.971px] shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-bold leading-[10.697px] relative shrink-0 text-[#1e225d] text-[8.32px] text-center tracking-[0.1189px]">1X</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4.16px] py-[3.301px] relative rounded-[2.971px] shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-bold leading-[10.697px] relative shrink-0 text-[#1e225d] text-[8.32px] text-center tracking-[0.1189px]">U</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4.16px] py-[3.301px] relative rounded-[2.971px] shrink-0">
      <p className="font-['Space_Grotesk',sans-serif] font-bold leading-[10.697px] relative shrink-0 text-[#1e225d] text-[8.32px] text-center tracking-[0.1189px]">:</p>
    </div>
  );
}
